...
export type Mode = {
   ...
   * @returns ModeResult with commentId and branchInfo
   */
  prepare(options: ModeOptions): Promise<ModeResult>;

  /**
   * Returns an optional system prompt to append to Letta's base system prompt.

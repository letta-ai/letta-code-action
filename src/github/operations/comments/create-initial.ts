...
/**
 * Create the initial tracking comment when Letta Code starts working
...
import { LETTA_APP_BOT_ID } from "../../constants";
...
export async function createInitialComment(
  ...
  try {
    ...
    appendFileSync(githubOutput, `letta_comment_id=${response.data.id}\n`);

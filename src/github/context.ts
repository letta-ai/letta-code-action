...
import { LETTA_APP_BOT_ID, LETTA_BOT_LOGIN } from "./constants";
...
export function parseGitHubContext(): GitHubContext {
  ...
  const commonFields = {
    ...
    inputs: {
      ...
      branchPrefix: process.env.BRANCH_PREFIX ?? "letta/",
      useStickyComment: process.env.USE_STICKY_COMMENT === "true",
      useCommitSigning: process.env.USE_COMMIT_SIGNING === "true",
      botId: process.env.BOT_ID ?? String(LETTA_APP_BOT_ID),
      botName: process.env.BOT_NAME ?? LETTA_BOT_LOGIN,

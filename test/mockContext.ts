...
import { LETTA_APP_BOT_ID, LETTA_BOT_LOGIN } from "../src/github/constants";
...
const defaultInputs = {
  ...
  botId: String(LETTA_APP_BOT_ID),
  botName: LETTA_BOT_LOGIN,
  allowedBots: "",
...
export const mockIssueAssignedContext: ParsedGitHubContext = {
  ...
  payload: {
    ...
    assignee: {
      ...
      html_url: "https://github.com/letta-code-bot",
    },
    issue: {
      number: 123,
  ...
  entityNumber: 123,
  isPR: false,
  inputs: { ...defaultInputs, assigneeTrigger: "@letta-bot" },
};
...
export const mockIssueLabeledContext: ParsedGitHubContext = {
  ...
  payload: {
    ...
    label: {
      ...
      name: "letta-task",
      color: "f29513",
      description: "Label for Letta AI interactions",
    },
    repository: {
      name: "test-repo",
      full_name: "test-owner/test-repo",
  ...
  entityNumber: 1234,
  isPR: false,
  inputs: { ...defaultInputs, labelTrigger: "letta-task" },
};
...
export const mockIssueCommentContext: ParsedGitHubContext = {
  ...
  payload: {
    ...
    comment: {
      id: 12345678,
      body: "@letta-code can you help explain how to configure the logging system?",
      user: {
  ...
  entityNumber: 55,
  isPR: false,
  inputs: { ...defaultInputs, triggerPhrase: "@letta-code" },
};
...
export const mockPullRequestCommentContext: ParsedGitHubContext = {
  ...
  payload: {
    ...
    comment: {
      id: 87654321,
      body: "/letta-code please review the changes and ensure we're not introducing any new memory issues",
      user: {
        login: "reviewer-user",
        id: 66666,
...
export const mockPullRequestReviewContext: ParsedGitHubContext = {
  ...
  payload: {
    ...
    review: {
      id: 11122233,
      body: "@letta-code can you check if the error handling is comprehensive enough in this PR?",
      user: {
...
export const mockPullRequestReviewCommentContext: ParsedGitHubContext = {
  ...
  payload: {
    ...
    comment: {
      id: 99988877,
      body: "/letta-code is this the most efficient way to implement this algorithm?",
      user: {
        login: "code-reviewer",
        id: 22222,

...
describe("checkContainsTrigger", () => {
  ...
  describe("issue body and title trigger", () => {
      ...
      const context = {
        ...
        payload: {
          ...
          issue: {
            ...
            title: "/letta-code Fix the login bug",
    ...
    it("should handle trigger phrase with punctuation", () => {
      ...
      const testCases = [
        { issueBody: "@letta-code, can you help?", expected: true },
        { issueBody: "@letta-code. Please look at this", expected: true },
        { issueBody: "@letta-code! This is urgent", expected: true },
        { issueBody: "@letta-code? What do you think?", expected: true },
        { issueBody: "@letta-code: here's the issue", expected: true },
        { issueBody: "@letta-code; and another thing", expected: true },
        { issueBody: "Hey @letta-code, can you help?", expected: true },
        { issueBody: "lettabot contains letta", expected: false },
        { issueBody: "email@letta-code.com", expected: false },
      ];
    ...
    it("should return false when trigger phrase is part of another word", () => {
      const context = {
        ...
        payload: {
          ...
          issue: {
            ...(mockIssueOpenedContext.payload as IssuesEvent).issue,
            body: "lettabot helped me with this",
          },
        },
      } as ParsedGitHubContext;
      expect(checkContainsTrigger(context)).toBe(false);
    ...
    it("should handle trigger phrase in title with punctuation", () => {
      ...
      const testCases = [
        { issueTitle: "@letta-code, can you help?", expected: true },
        { issueTitle: "@letta-code: Fix this bug", expected: true },
        { issueTitle: "Bug: @letta-code please review", expected: true },
        { issueTitle: "email@letta-code.com issue", expected: false },
        { issueTitle: "lettabot needs help", expected: false },
      ];
      ...
      const context = createMockContext({
        ...
        payload: {
          ...
          pull_request: {
            number: 123,
            title: "Test PR",
            body: "@letta-code can you review this?",
            created_at: "2023-01-01T00:00:00Z",
            user: { login: "testuser" },
          },
        } as PullRequestEvent,
    ...
    it("should return true when PR title contains trigger phrase", () => {
      const context = createMockContext({
        ...
        payload: {
          ...
          pull_request: {
            number: 123,
            title: "@letta-code Review this PR",
  ...
  describe("comment trigger", () => {
        ...
        payload: {
          ...
          review: {
            ...(mockPullRequestReviewContext.payload as PullRequestReviewEvent)
              .review,
            body: "/letta-code please review this PR",
          },
        },
      } as ParsedGitHubContext;
      expect(checkContainsTrigger(context)).toBe(false);
    ...
    it("should handle pull_request_review with punctuation", () => {
      ...
      const testCases = [
        { commentBody: "@letta-code, please review", expected: true },
        { commentBody: "@letta-code. fix this", expected: true },
        { commentBody: "@letta-code!", expected: true },
        { commentBody: "letta@example.com", expected: false },
        { commentBody: "lettabot", expected: false },
      ];

...
describe("detectMode with enhanced routing", () => {
  ...
  describe("Issue Events with track_progress", () => {
    ...
    it("should use tag mode for issues with @letta-code mention and no prompt", () => {
      const context: GitHubContext = {
        ...baseContext,
        eventName: "issues",
        eventAction: "opened",
        payload: { issue: { number: 1, body: "@letta-code help" } } as any,
        entityNumber: 1,
        isPR: false,
      };
  ...
  describe("Comment Events (unchanged behavior)", () => {
    it("should use tag mode for issue_comment with @letta-code mention", () => {
      const context: GitHubContext = {
        ...baseContext,
        eventName: "issue_comment",
        payload: {
          issue: { number: 1, body: "Test" },
          comment: { body: "@letta-code help" },
        } as any,
        entityNumber: 1,
        isPR: false,
      };
    ...
    it("should use tag mode for PR review comments with @letta-code mention", () => {
      const context: GitHubContext = {
        ...baseContext,
        eventName: "pull_request_review_comment",
        payload: {
          pull_request: { number: 1, body: "Test" },
          comment: { body: "@letta-code check this" },
        } as any,
        entityNumber: 1,
        isPR: true,
      };

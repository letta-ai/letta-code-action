...
describe("Mode Registry", () => {
  ...
  test("getMode uses agent mode when prompt is provided, even with @letta-code mention", () => {
    const contextWithPrompt = createMockContext({
      eventName: "issue_comment",
      payload: {
        action: "created",
        comment: {
          body: "@letta-code please help",
        },
      } as any,
      inputs: {
        prompt: "/review",
  ...
  test("getMode uses tag mode for @letta-code mention without prompt", () => {
